...
<body style="background-image:url(img/bg.jpg)">
    ...
    <div style="height: 60px; width:900px;margin-left :162px; ">
        ...
        <ul style="margin-top: 0px; margin-left:210px; font-size:20px; font-weight :bolder">
         ...
         <li style =" display :inline ; margin-right :50px"><a href ="">北碚</a></li>
         <li style =" display :inline ; margin-right :50px"><a href ="">永川</a></li>
         <li style =" display :inline ; margin-right :50px"><a href ="">奉节</a></li>
         <li style =" display :inline ; margin-right :50px"><a href ="">綦江</a></li>
         <li style =" display :inline ; margin-right :50px"><a href ="">更多>></a></li>
        </ul>
        </div>
        
    </div>

    <hr style=" margin-top:5px; width:1200px" />
    ...
    <div style="height: 43px; width:900px;margin-left :250px; text-align: center; margin-bottom: 0px;">
      <p><a href ="admini_login.aspx">商品后台管理</a></p>
